(() => {
  ...
  var init_phoenix_live_view_esm = __esm({
    "../../deps/phoenix_live_view/priv/static/phoenix_live_view.esm.js"() {
      ...
      PHX_NO_UNUSED_FIELD = "no-unused-field";
      ...
      closestPhxBinding = (startEl, binding, borderEl) => {
        let el = startEl;
        do {
